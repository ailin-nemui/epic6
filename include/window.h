...
#define message_setall(x, y, z) real_message_setall(x, y, z, __FILE__, __LINE__)
	...
	const char *		get_window_current_activity_data 	(int);
	const char *		get_window_current_activity_format	(int);
	...
	const char *		get_window_name 			(int);
	List *		get_window_nicks			(int);
	int		get_window_notified			(int);
	const char *		get_window_notify_name 			(int);
	...
	const char *		get_window_topline 			(int, int);
	int		get_window_toplines_showing 		(int);
	int		get_window_user_refnum			(int);
	const char *		get_window_uuid				(int);
	int		get_window_scroll_lines			(int);
	const char *		get_window_log_rewrite 			(int);
